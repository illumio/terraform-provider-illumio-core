...
sidebar_current: "docs-illumio-core-resource-workload"
subcategory: ""
description: |-
  Manages a Workload in the Illumio PCE
---
...
!> This resource is deprecated as of v0.2.0 and will be removed in v1.0.0. Use `illumio-core_unmanaged_workload` instead
