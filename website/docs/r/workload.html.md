...
- **agent_to_pce_certificate_authentication_id** (String) PKI Certificate identifier to be used by the PCE for authenticating the VEN. The ID should be in between 1 to 255 characters
...
- **hostname** (String) The hostname of this workload. The hostname should be in between 1 to 255 characters
...
- **name** (String) Name of the Workload. The name should be in between 1 to 255 characters.
...
- **service_principal_name** (String) The Kerberos Service Principal Name (SPN). The SPN should be in between 1 to 255 characters
...
- **default_gateway_address** (Boolean) Default Gateaway Address of the Interface. The Default Gateaway Address should in the IPv4 or IPv6 format.
